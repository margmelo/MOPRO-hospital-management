...
public class Data implements Serializable {
     ...
     */
    private static String[] nomeDiaDaSemana = {"dom", "2f", "3f", "4f", "5f", "6f", "sáb"};
     ...
     */
    private static String[] nomeMes = {"inv", "Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"};
    ...
    /**
     * Modifica o ano, o mes e o dia da data.
     *
    ...
    public String toString() {
        return determinarDiaDaSemana() + " " + dia + "." + nomeMes[mes] + "." + ano;
    }
